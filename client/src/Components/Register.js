import { Button, FormControl, FormHelperText, FormLabel, Input, InputGroup, InputLeftAddon, InputRightElement, useDisclosure, useToast } from "@chakra-ui/react"
...
const Register = () => { 
    ...
    return (
              ...
              <Button colorScheme='blue' mr={3} onClick={(e)=>{handleRegister(e);display()}}>
                Valider
              </Button>
